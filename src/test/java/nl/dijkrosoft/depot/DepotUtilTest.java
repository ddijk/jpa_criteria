...
public class DepotUtilTest {
    ...
    public void testFlatMapToDeclarations() throws IOException {
        ...
        expectedDeclarations.add(new Declaration(123.45, "2019", "inv1", VERKRUISEN));
        expectedDeclarations.add(new Declaration(723.45, "2020", "inv1", VERKRUISEN));
    ...
    public void testCalculatePayableDeclarations() throws IOException {
        ...
        expectedDeclaratieBetalingen.add(new DeclaratieBetaling(new Declaration(123.45, "2019", "inv1", VERKRUISEN), true, 123.45));
        expectedDeclaratieBetalingen.add(new DeclaratieBetaling(new Declaration(723.45, "2020", "inv1", VERKRUISEN), true, 723.45));
